...
<html>
	...
	<body onLoad="JavaScript:form.userx.focus();">
    	<form name="form" method="post" action="userRootCompanyCreateResult.jsp?id=<%=ID%>" onsubmit="return verity()">
                            ...
                            <div class="7u 12u$(xsmall)">
                                <div class="select-wrapper">
                                    <select name="userGroupID">
                                        ...
                                        %>
                                        <option value="<%=userGroupSchema.ID%>"><%=userGroupSchema.Namex%></option>
