...
<html>
    ...
    <body>
        <form name="form" method="post" action="userGroupRoot.jsp">
                            ...
                            <table class="alt">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="userRootGroup.jsp?id=<%=companySchema.ID%>">
                                                <%=companySchema.Namex%>
                                            </a>
                                        </td>
                                            ...
                                            <%
                                                if(number!=0)
                                                {
                                                    ...
                                                    for(int i=1;i<=totalPages;i++)
                                                    {
                                                        ...
                                                        if(currentPageNo!=i)
                                                            out.print("&nbsp;<a "+"href='userRootGroup.jsp?currentPageNo="+i+"&start="+startNumber+"&end="+endNumber+"&keyword="+(keyword==null?"":keyword)+"'>"+i+"</a>");
                                                        else
                                                            out.println("&nbsp;<B>"+i+"<B>");
                                                    }   
                                                }
