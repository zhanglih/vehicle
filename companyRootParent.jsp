...
<%
    ...
    else
    {
        ...
        String whereClause="ParentID = " + ID ;
        ...
        if(keyword!=null)
        {
            ...
            if(endDate=="")
                whereClause="Namex like '~"+keyword.trim()+"~' AND "+"RegisteredTime>='"+startDate+" 00:00:00' AND RegisteredTime"+"<'"+MiscTool.getNow().split(" ")[0]+" 23:59:59'"+" AND ParentID = " + ID;
            else
                whereClause="Namex like '~"+keyword.trim()+"~' AND "+"RegisteredTime>='"+startDate+" 00:00:00' AND RegisteredTime"+"<'"+endDate+" 23:59:59'"+" AND ParentID = " + ID;
        }
...
<html>
    ...
    <body>
        <form name="form" method="post" action="companyRootParent.jsp?id=<%=ID%>" onsubmit="" style="margin-bottom:0">
        <!-- Wrapper -->
            <div id="wrapper">
                                    ...
                                    <div class="row uniform">
                                        ...
                                        <div class="2u 3u$(xsmall)">
                                            <div class="12u$">
                                                <ul class="actions">
                                                    <li>
                                                        <input type="button" value="新建" class="special" onClick="JavaScript:window.location.href='companyRootParentCreate.jsp?id=<%=ID%>'"/>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <table class="alt">
                                            ...
                                            %>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="companyChildInfo.jsp?id=<%=company.ID%>">
                                                                    <%=company.Namex%>
                                                                </a>
                                                            </td>
                                                    ...
                                                    <%
                                                        if(number!=0){
                                                            ...
                                                            for(int i=1;i<=totalPages;i++){
                                                                ...
                                                                if(currentPageNo!=i)
                                                                    out.print(
                                                                    "&nbsp;<a href='companyRootParent.jsp?currentPageNo="
                                                                    +i
                                                                    +"&keyword="
                                                                    +keyword
                                                                    +"&start="
