...
<%
    ...
    else
    {
        ...
        //筛选所选公司下所有员工用户条件
        String whereClause="CompanyID="+userxSchema.ID;
        //接收页面搜索框输入参数
        String keyword=request.getParameter("keyword");
        if("".equals(keyword))
            whereClause="CompanyID="+userxSchema.ID;
...
<html>
    ...
    <body>
        <form name="form" method="post" action="companyToUser.jsp">
                    ...
                    <section>
                        ...
                        <div class="table-wrapper">
                            <div class="row uniform">
                                ...
                                <div class="2u 2u$(xsmall)" align="right">
                                    <div class="12u$">
                                        <ul class="actions">
                                            ...
                                            <%
                                                if(number!=0)
                                                {
                                                    ...
                                                    for(int i=1;i<=totalPages;i++)
                                                    {
                                                        ...
                                                        if(currentPageNo!=i)
                                                            out.print("&nbsp;<a "+"href='companyToUser.jsp?currentPageNo="+i+"&start="+startNumber+"&end="+endNumber+"&keyword="+(keyword==null?"":keyword)+"&id="+userxSchema.ID+"'>"+i+"</a>");
                                                        else
                                                            out.println("&nbsp;<B>"+i+"<B>");
                                                    }   
                                                }
