<!--
	描述:接收root用户新建公司名下用户界面传递的数据并作出响应。
    作者:杜乘风
    手机:13247191605
    微信:13247191605
    日期:2017.06.07
...
<%
	...
	else
	{
		...
		int companyID = companySchema.ID;
		...
		UserxSchema userxSchema1 = blUserx.getSchema(userID);

		LogxSchema logxSchema = new LogxSchema();
        logxSchema.CompanyID = userxSchema1.CompanyID;
        logxSchema.UserxID = userxSchema1.ID;
